...
//         res.status(201).json({ msg: "Thêm NXB thành công.", publisher: newPublisher });

//     } catch (error) {
//         console.error(error);
//         res.status(500).json({ msg: "Lỗi server khi thêm NXB." });
//     }
// };
...
// /**
//  * Lấy một Publisher theo id
//  */
// exports.getPublisherByMaNXB = async (req, res) => {
//     try {
//         const { id } = req.params;
//         const publisher = await Publisher.findOne({ id });
...
// /**
//  * Xoá một Publisher theo id
//  */
// exports.deletePublisher = async (req, res) => {
//     try {
//         const { id } = req.params;

//         const deletedPublisher = await Publisher.findOneAndDelete({ id });
